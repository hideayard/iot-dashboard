...
$table = "node";
$txt_field= "node_id, node_name, node_remark, node_status";
$txt_label = "Name,Remark,Status";
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="addnode" ><button type="button" class="btn btn-success">
                  Add Node
                </button></a>
            </div>
            <!-- /.card-header -->
  ...
  foreach($data as $key => $value)
    {
      ...
      if($tipe_user == "ADMIN")
      {
        echo '<a href="index.php?page=nodeform&mode=edit&node_id='.$value["node_id"].'" class="btn btn-primary"><span><i class="fa fa-edit"></i></span></a> | <a onclick="actiondelete(\'settings\',\'settings\','.$value["node_id"].')" class="btn btn-danger"><span><i class="fa fa-trash"></i></span></a>' ;
      }
      else
      {
        echo '<a href="index.php?page=nodeform&node_id='.$value["node_id"].'" class="btn btn-primary"><span><i class="fa fa-eye"></i></span></a> ';
      }
      ...
      {
        if($key2 == 2) {
            if($value[trim($value2)] == 1) {
                echo "<td>Active</td>";
            } else {
                echo "<td>Nonactive</td>";
            }
        }
        else {
